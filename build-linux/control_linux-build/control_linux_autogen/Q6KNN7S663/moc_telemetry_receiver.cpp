/****************************************************************************
** Meta object code from reading C++ file 'telemetry_receiver.h'
**
...
#include "../../../../control_linux/net/telemetry_receiver.h"
...
#error "The header file 'telemetry_receiver.h' doesn't include <QObject>."
...
template <> constexpr inline auto TelemetryReceiver::qt_create_metaobjectdata<qt_meta_tag_ZN17TelemetryReceiverE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(proto::Telemetry)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void TelemetryReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->telemetryReceived((*reinterpret_cast<std::add_pointer_t<proto::Telemetry>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TelemetryReceiver::*)(proto::Telemetry )>(_a, &TelemetryReceiver::telemetryReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void TelemetryReceiver::telemetryReceived(proto::Telemetry _t1)
{
