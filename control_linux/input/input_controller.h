...
// XKB hardware keycodes (evdev keycode + 8), as reported by
// QKeyEvent::nativeScanCode() on both the xcb and wayland platform plugins.
// Unlike Qt::Key they do not follow the active keyboard layout, so WASD keeps
// working on a Cyrillic layout.
namespace vkey {
constexpr int W = 25;
constexpr int A = 38;
constexpr int S = 39;
constexpr int D = 40;
constexpr int Left = 113;
constexpr int Up = 111;
constexpr int Right = 114;
constexpr int Down = 116;
}  // namespace vkey
