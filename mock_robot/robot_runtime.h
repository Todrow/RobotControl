...
struct RobotRuntime {
    ...
    // Shared drive permissions: LiDAR guard writes, command thread reads.
    MotionPermissions permissions;
};
...
void runTelemetrySender(const RobotOptions&, RobotRuntime&, const LidarGuard&);
